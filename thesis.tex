...
\subsubsection{Výzvy a úskalí standardních metod}
...
Následující sekce bude věnována návrhu a implementaci specializovaných modelů neuronových sítí pro odstranění šumu z rentgenových snímků. Sekce bude zahrnovat charakteristiku použitých knihoven a technologií, nastavení projektu pomocí nástroje Poetry a detailní popis tří různých modelů neuronových sítí: DnCNN, DAE a UNet. Popis modelů bude obsahovat podrobnosti o tom, jak jednotlivé modely fungují a bude také podrobně popsána jejich implementace, s důrazem na výsledky dosažené při odstraňování šumu.

\subsection{Project setup - libraries and technologies}
\subsection{Configuration files or overview of project}
\subsection{Description of neural networks DnCNN, DAE, UNet with images}
