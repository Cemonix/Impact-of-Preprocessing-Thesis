...
% Autoenkodér pro redukci šumu (DAE):
% Describe the architecture of the DAE, including encoder and decoder components.
% Explain how the DAE reconstructs images and the loss function used for training.
% Provide details on the training process and any specific techniques used to enhance performance.
% Include code snippets for the model architecture and training loop if space allows.
