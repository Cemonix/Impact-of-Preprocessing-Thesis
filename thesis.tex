...
% Define and explain the metrics used to evaluate the models (e.g., PSNR, SSIM).
% Justify the choice of these metrics and how they relate to the task of denoising.

% Výsledky neuronových sítí DnCNN a DAE při redukci šumu z rentgenových snímků:
% Present the results obtained from training and evaluating both models.
% Use tables and graphs to compare the performance of DnCNN and DAE.
% Discuss the results, highlighting strengths and weaknesses of each model.
% Mention any insights gained from the experiments and how they can inform future work.
